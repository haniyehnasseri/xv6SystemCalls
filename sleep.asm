  ...
  22:	c3                   	ret    
{
  ...
  int pid;
  pid=fork();
  23:	e8 72 02 00 00       	call   29a <fork>
  if(pid==0){
  28:	85 c0                	test   %eax,%eax
  2a:	75 05                	jne    31 <main+0x31>
  	cmos();
  	sleepp(atoi(argv[1]));
  	cmos();
  }
...
exit();
  2c:	e8 71 02 00 00       	call   2a2 <exit>
  ...
  31:	e8 74 02 00 00       	call   2aa <wait>
  	...
  	cmos();
  36:	e8 2f 03 00 00       	call   36a <cmos>
  	sleepp(atoi(argv[1]));
  3b:	83 ec 0c             	sub    $0xc,%esp
  3e:	ff 73 04             	pushl  0x4(%ebx)
  41:	e8 ea 01 00 00       	call   230 <atoi>
  46:	89 04 24             	mov    %eax,(%esp)
  49:	e8 14 03 00 00       	call   362 <sleepp>
  	cmos();
  4e:	e8 17 03 00 00       	call   36a <cmos>
  53:	83 c4 10             	add    $0x10,%esp
  56:	eb d4                	jmp    2c <main+0x2c>
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
